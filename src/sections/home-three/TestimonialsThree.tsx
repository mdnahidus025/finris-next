...
const TestimonialsThree: React.FC = () => {
    ...
    return (
        <section className="testimonial-two">
            <div className="testimonial-two__shape-bg-1" style={{ backgroundImage: `url(${shapeBg1})` }} ></div>
            <div className="testimonial-two__shape-bg-2" style={{ backgroundImage: `url(${shapeBg2})` }}></div>
                                ...
                                <div className="testimonial-two__single">
                                    <div className="testimonial-two__img-box">
                                        <div className="testimonial-two__img">
                                            <Image src={t.image} width={320} height={380} loading='lazy' alt={t.name} />
                                        </div>
                                    </div>
